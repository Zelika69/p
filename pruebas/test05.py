...
class TrianguloRectanguloCalculator:
    def __init__(self, root):
        ...
        self.var_alpha = tk.StringVar(value="30")  # Valor de ejemplo para alpha
        ...
        self.var_beta = tk.StringVar(value="60")  # Valor de ejemplo para beta
        ...
        # Botón para limpiar
        btn_limpiar = ttk.Button(root, text="Limpiar", command=self.limpiar_datos)
        btn_limpiar.grid(row=7, column=0, columnspan=2, pady=10)

        # Etiquetas para los resultados
        self.lbl_resultados_theta = tk.Label(root, text="")
        self.lbl_resultados_theta.grid(row=8, column=0, columnspan=2, pady=5, padx=10)

        self.lbl_resultados_alpha = tk.Label(root, text="")
        self.lbl_resultados_alpha.grid(row=9, column=0, columnspan=2, pady=5, padx=10)

        self.lbl_resultados_beta = tk.Label(root, text="")
        self.lbl_resultados_beta.grid(row=10, column=0, columnspan=2, pady=5, padx=10)

        self.lbl_resultados_co = tk.Label(root, text="")
        self.lbl_resultados_co.grid(row=11, column=0, columnspan=2, pady=5, padx=10)

        self.lbl_resultados_ca = tk.Label(root, text="")
        self.lbl_resultados_ca.grid(row=12, column=0, columnspan=2, pady=5, padx=10)

        self.lbl_resultados_h = tk.Label(root, text="")
        self.lbl_resultados_h.grid(row=13, column=0, columnspan=2, pady=5, padx=10)
    ...
    def calcular_resultados(self):
        ...
        # Verificar si la suma de los ángulos es 180 grados
        if angulos_ingresados == 3 and sum([theta, alpha, beta]) != 180:
            messagebox.showerror("Error", "La suma de los ángulos debe ser 180 grados.")
            return
        ...
        if lados_ingresados >= 2 and angulos_ingresados == 0:
            ...
            if not math.isclose(CO**2 + CA**2, H**2):
                messagebox.showerror("Error", "Los valores ingresados no cumplen con el Teorema de Pitágoras.")
                return
    ...
    def limpiar_datos(self):
        # Limpiar las entradas y las etiquetas
        self.var_co.set("")
        self.var_ca.set("")
        self.var_h.set("")
        self.var_theta.set("")
        self.var_alpha.set("30")  # Valor de ejemplo para alpha
        self.var_beta.set("60")   # Valor de ejemplo para beta
        self.lbl_resultados_theta.config(text="")
        self.lbl_resultados_alpha.config(text="")
        self.lbl_resultados_beta.config(text="")
        self.lbl_resultados_co.config(text="")
        self.lbl_resultados_ca.config(text="")
        self.lbl_resultados_h.config(text="")
