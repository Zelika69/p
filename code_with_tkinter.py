...
def calcular_triangulo_rectangulo(opcion):
    while True:
        if opcion == 1:
            ...
            nota = "Nota: Estos son los calculos para este triángulo Rectángulo."
            break
...
Nota: Estos son los  valores calculados 
para el triángulo rectangulo.'''
            if angulo_beta == 0 or angulo_alpha == 0 or cateto_opuesto == hipotenusa or cateto_adyacente == hipotenusa or math.sqrt((cateto_opuesto**2) + (cateto_adyacente**2)) != hipotenusa or ((cateto_opuesto**2) + (cateto_adyacente**2)) != hipotenusa**2:
                nota = "Nota: No se puede trazar este triángulo."
                angulo_alpha = 0
                angulo_beta = 0
                cateto_opuesto = 0
                cateto_adyacente = 0
                ...
                nota = "Nota: Estos son los calculos para el triángulo Rectángulo."
            break

        elif opcion == 4:
            while True:
                cateto_adyacente = simpledialog.askfloat("Cateto Adyacente", "Ingrese la medida del cateto adyacente: ")
                if cateto_adyacente is None or cateto_adyacente == 0:
                    messagebox.showerror("Error", "Ingrese un valor válido.")
                else:
                    break
            while True:
...
para el triángulo rectangulo.'''
            ...
            while True:
                ...
                if angulo_alpha is None or angulo_alpha == 0 or angulo_alpha > 90 or angulo_alpha == 90:
                        messagebox.showerror("Error", "Ingrese un valor válido.")
                else:
                    break
            angulo_beta = 90 -(angulo_alpha)
...
para el triángulo rectangulo.'''
        ...
        para el triángulo rectangulo.'''
            ...
            while True:
                ...
                if hipotenusa is None or hipotenusa == 0:
                    messagebox.showerror("Error", "Ingrese un valor válido.")
                elif cateto_adyacente >= hipotenusa:
                    messagebox.showerror("Error", "El cateto adyacente debe ser menor que la hipotenusa.")
                else:
                    break
        ...
        para el triángulo rectangulo.'''
            ...
            while True:
                ...
                if hipotenusa is None or hipotenusa == 0:
                    messagebox.showerror("Error", "Ingrese un valor válido.")
                elif cateto_opuesto >= hipotenusa:
                    messagebox.showerror("Error", "El cateto opuesto debe ser menor que la hipotenusa.")
                else:
                    break
...
def mostrar_resultados(resultados, unidades):
    if resultados:
        ...
        label_angulo_alpha = tk.Label(frame_resultados, text=f"Ángulo Alpha: {resultados[3]:.4f}°", font=("Arial", 20))
        label_angulo_alpha.grid(row=3, column=0, sticky="w", padx=10, pady=5)

        label_angulo_beta = tk.Label(frame_resultados, text=f"Ángulo Beta: {resultados[4]:.4f}°", font=("Arial", 20))
        ...
        menu_unidades.grid(row=6, column=0, padx=10, pady=5)
        ...
        button_cambiar.grid(row=6, column=1, padx=10, pady=5, columnspan=2)

        button_volver = tk.Button(frame_resultados, text="Volver al Menú Principal", command=volver_al_menu, font=("Arial", 20))
        button_volver.grid(row=7, column=0, columnspan=2, padx=10, pady=5)
